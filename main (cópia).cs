...
public class Robo
{
    ...
    public void Centralizar3Meio()
    {
        ...
        {
            var ang = bc.Compass();
            GirarAteAngulo(System.Convert.ToInt32(ang));
        }
   ...
   public void run()
    {
        ...
        else if(sensorCor4 == "VERDE" || sensorLuz4 <= 50 && sensorLuz5 <= 50 && sensorLuz3 <= 50)
        {
            ...
            bc.MoveFrontalAngles(1000, -6);
            RealizarLeituras();
            if (sensorCor4 == "VERDE" || sensorLuz4 <= 50 && sensorLuz5 <= 50 && sensorLuz3 <= 50)
            {
                bc.MoveFrontalAngles(1000, 6);
                VirarEsquerda();
            }
